...
var file_agents_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xcd, 0x01, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f,
	...
	0x6f, 0x61, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73,
	0x70, 0x61, 0x63, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65,
	0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x0d, 0x0a, 0x0b, 0x53, 0x65, 0x74, 0x4c, 0x61, 0x6d, 0x65,
...
var file_agents_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_agents_proto_goTypes = []any{
	...
	(*SpawnAgentBinary)(nil),        // 22: agents.SpawnAgentBinary
	(*GetNodeInfo)(nil),             // 23: agents.GetNodeInfo
	(*NodeInfo)(nil),                // 24: agents.NodeInfo
	(*WorkloadSummary)(nil),         // 25: agents.WorkloadSummary
	(*SetLameDuck)(nil),             // 26: agents.SetLameDuck
	(*LameDuckResponse)(nil),        // 27: agents.LameDuckResponse
	(*AgentRegistered)(nil),         // 28: agents.AgentRegistered
	(*CheckRegistered)(nil),         // 29: agents.CheckRegistered
	(*Halt)(nil),                    // 30: agents.Halt
	nil,                             // 31: agents.PingNodeResponse.TagsEntry
	nil,                             // 32: agents.PingNodeResponse.RunningAgentsEntry
	nil,                             // 33: agents.PingAgentResponse.TagsEntry
	nil,                             // 34: agents.AuctionResponse.TagsEntry
	nil,                             // 35: agents.AuctionResponse.StatusEntry
	nil,                             // 36: agents.NoEnvRunRequest.ClearEnvEntry
	nil,                             // 37: agents.NodeInfo.TagsEntry
	(*timestamppb.Timestamp)(nil),   // 38: google.protobuf.Timestamp
}
var file_agents_proto_depIdxs = []int32{
	38, // 0: agents.PingNodeResponse.started_at:type_name -> google.protobuf.Timestamp
	31, // 1: agents.PingNodeResponse.tags:type_name -> agents.PingNodeResponse.TagsEntry
	32, // 2: agents.PingNodeResponse.running_agents:type_name -> agents.PingNodeResponse.RunningAgentsEntry
	33, // 3: agents.PingAgentResponse.tags:type_name -> agents.PingAgentResponse.TagsEntry
	38, // 4: agents.PingAgentResponse.started_at:type_name -> google.protobuf.Timestamp
	6,  // 5: agents.PingAgentResponse.running_workloads:type_name -> agents.RunningWorkload
	25, // 6: agents.PingWorkloadResponse.workload:type_name -> agents.WorkloadSummary
	38, // 7: agents.AuctionResponse.started_at:type_name -> google.protobuf.Timestamp
	34, // 8: agents.AuctionResponse.tags:type_name -> agents.AuctionResponse.TagsEntry
	35, // 9: agents.AuctionResponse.status:type_name -> agents.AuctionResponse.StatusEntry
	...
	36, // 12: agents.NoEnvRunRequest.clear_env:type_name -> agents.NoEnvRunRequest.ClearEnvEntry
	9,  // 13: agents.NoEnvRunRequest.run_request:type_name -> agents.StartWorkload
	25, // 14: agents.WorkloadList.workloads:type_name -> agents.WorkloadSummary
	37, // 15: agents.NodeInfo.tags:type_name -> agents.NodeInfo.TagsEntry
	25, // 16: agents.NodeInfo.workloads:type_name -> agents.WorkloadSummary
	38, // 17: agents.WorkloadSummary.started_at:type_name -> google.protobuf.Timestamp
