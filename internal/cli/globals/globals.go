...
type Globals struct {
	Config kong.ConfigFlag `short:"c" env:"NEX_CONFIG" help:"Configuration file" type:"existingfile" placeholder:"./config.json" group:"Nex Configuration" json:"globals_config"`
	// Namespace for scoping workload requests
	Namespace string `env:"NEX_NAMESPACE" placeholder:"default" help:"Specifies namespace when running nex commands" group:"Nex Configuration" json:"globals_namespace"`
	// CLI version
