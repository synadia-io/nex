...
var _ hostservices.HostService = &ObjectStoreService{}
...
func (o *ObjectStoreService) HandleRequest(
	...
	objectStoreName := metadata[hostservices.BucketContextHeader]
...
func (o *ObjectStoreService) handleGet(
	...
	name := metadata[hostservices.ObjectStoreObjectNameHeader]
	if name == "" {
