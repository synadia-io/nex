...
// TestNatsConnectionOptions verifies that the NATS connection options keep the
// client reconnecting through auth errors (e.g. an expired/rotated JWT) instead
// of permanently aborting the reconnect loop.
...
// TestNatsConnectionOptions_CredsFile verifies that when NEX_AGENT_NATS_CREDS_FILE
